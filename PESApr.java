...
public class PESApr{
	...
	private void initialize(){
		...
		// ZONA DE TEXT
		JTextArea txtrAjsfdsjasvjcasjv = new JTextArea();
		txtrAjsfdsjasvjcasjv.setText("ajsfdsjasvjcasjv");
		//txtrAjsfdsjasvjcasjv.setBorder(new LineBorder(new Color(0, 0, 0), 2));
		//txtrAjsfdsjasvjcasjv.setBackground(new Color((int)(240*0.9), (int)(230*0.9), (int)(140*0.9)));//new Color(240, 230, 140));

		txtrAjsfdsjasvjcasjv.setLineWrap(true);
		txtrAjsfdsjasvjcasjv.setFont(new Font("Yu Mincho Demibold", Font.BOLD, 18));
		txtrAjsfdsjasvjcasjv.setBounds(61, 347, 319, 83);
		frmPesa.getContentPane().add(txtrAjsfdsjasvjcasjv);
		txtrAjsfdsjasvjcasjv.setVisible(false);
		//txtrAjsfdsjasvjcasjv.setAlignment(Component.CENTER);
		////////
		...
		btnTgCucu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				txtrAjsfdsjasvjcasjv.setText("Tramvaiul vine in statie (/pleaca)");
               /* map.getUiLayer()
		...
		btnBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				txtrAjsfdsjasvjcasjv.setVisible(false);
				txtrAjsfdsjasvjcasjv.setText("Verifica PESA");
			}
		});
		...
		btnZoneDeInteres.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				txtrAjsfdsjasvjcasjv.setVisible(true);
			}
		});
